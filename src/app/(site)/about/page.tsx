...
export const metadata: Metadata = {
  title: "About Us",
  description: "An independent, global digital magazine created to tell stories that reveal meaning, beauty, and depth.",
};

const highlights = [
  { icon: Globe, title: "Global Reach", description: "Stories that cross cultures, countries, and time" },
  { icon: BookOpen, title: "Values-Driven", description: "Kindness, justice, courage, and wisdom" },
  { icon: Users, title: "Diverse Voices", description: "Multiple countries and realities united" },
  { icon: Sparkles, title: "Timeless Perspective", description: "Depth over immediacy, meaning over noise" },
];
        ...
        <section className="relative bg-primary/10 py-16 md:py-24 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative">
            <div className="max-w-3xl mx-auto text-center">
              <span className="inline-block text-primary font-medium tracking-widest uppercase text-sm mb-4">Who We Are</span>
              <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">About Us</h1>
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                An independent, global digital magazine created to tell stories that cross cultures, countries, and time — stories that reveal meaning, beauty, and depth
              </p>
            </div>
          </div>
        </section>
            ...
            <article className="max-w-4xl mx-auto">
              <div className="relative mb-12 p-8 bg-muted/30 rounded-lg border-l-4 border-primary">
                <p className="text-xl md:text-2xl font-serif text-foreground italic leading-relaxed">
                  &ldquo;We are a values-driven media platform. We believe that kindness, justice, courage, and wisdom are not circumstantial ideas or contemporary trends, but universal virtues.&rdquo;
                </p>
              </div>
              ...
              <div className="pt-12 mt-12 border-t border-border text-center">
                <h2 className="font-serif text-3xl font-semibold text-foreground mb-2">GrowBiz Magazine</h2>
                <p className="text-primary font-medium tracking-wide uppercase text-sm">The Global Media of Virtues.</p>
              </div>
            </article>
          </div>
        </section>
